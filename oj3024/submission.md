...
```text
-ใช้ function main()
- รับค่า input allsscore และ highscore 
- คำนวนหาโอกาสที่ค่าน้อยที่สุดโดยหาค่า2 ตัวที่เหลื่อจากการเอาจำนวนรวมมาลบกับ ค่าที่มากทีสุด
- จากนั้นจะหาค่าที่น้อยที่สุดที่เป็นไปได้โดย นำผลบวกของ 2 จำนวนที่เหลื่อมา ลบกับคะแนนนมากที่สุด จะได้ค่าที่มีโอกาสน้อยที่สุดออกมา
- check ก่อนว่า ถ้าค่าที่น้อยที่สุด มีค่าน้อยกว่า 0 หรือเปล่าถ้าน้อยกว่าให้ เปลี่ยนค่าที่น้อยที่สุด = 0 
- ใช่ if else โดยกำหนดเงื่อนไขตามโจทย์ว่าถ้า high score - lowest score <= 2 ให้ print(Not surprising) else ให้ print(Surprising)
```
...
```text
คำนวนหาวิธี คำนวน / สูตรที่ใช้ ก่อน แล้ววค่อยแปลงเป็น code
```
