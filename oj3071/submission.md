...
```text
-รับ input A B C D ตามโจทย์กำหนด
-สร้าง list name alls ไว้เก็บจำนวน answer
- looped ตังเเต่ A - B  in loop check ว่า i หารด้วย C เเล้วเหลือ D ไหม ถ้า เท่ากับ D ให้ เป็บลง list ถ้าไม่ให้ conitnew
- เเล้ว print จำนวนที่อยุ่ใน list alls
```
...
```text
ใช้ loop check ทีละตัว เเล้ว ใส่เข้าไปใน list
```
...
```text
ถ้าวิธีสุดท้ายเหมือนกับแผนแรก ใช้ loop check ทีละตัว
```
