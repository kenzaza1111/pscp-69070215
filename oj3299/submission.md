...
```text
- รับค่า L และ N
- L คือจำนวนแนวทแยงที่รวมกันเป็น 1 แถบ
- N คือจำนวนช่องที่ปลูกทั้งหมด
- ต้องหาว่าช่องที่ N อยู่ในแถบที่เท่าไร
- แต่ละแนวทแยงจะมีจำนวนช่องเพิ่มขึ้นทีละ 1
- จึงใช้การบวกจำนวนช่องของแต่ละแนวทแยงไปเรื่อย ๆ
- เมื่อบวกครบ L แนวทแยง จะเปลี่ยนไปแถบถัดไป
- ถ้าจำนวนช่องที่บวกสะสมถึง N แสดงว่า N อยู่ในแถบนั้น
```
...
```text
สร้าง for loop แล้วบวกจำนวนช่องของแต่ละแนวทแยงเข้า total
แล้วนับว่าครบ L แนวทแยงหรือยัง
ถ้าครบ L ให้เปลี่ยน band ไปแถบถัดไป
ถ้า total ถึงหรือมากกว่า N ให้ print band
```
...
```text
ใช้ for loop ตั้งแต่ 1 เป็นต้นไป
ในแต่ละรอบจะเอา i ไปบวกกับ total
แล้วนับจำนวนแนวทแยงด้วย count

ถ้า total มากกว่าหรือเท่ากับ N
ให้ print band แล้วหยุด loop

ถ้า count ครบ L
ให้เพิ่ม band อีก 1 และ reset count เป็น 0
```
...
```text
เป็นกรณีที่ N มีค่าน้อย และอยู่ในแถบแรก
```
