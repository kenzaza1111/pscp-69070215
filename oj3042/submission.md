...
-สร้าง function main()
-รับ input N 
-สร้าง listn ไว้เก็น ตัวที่หาร 10 ลงตัว
-for loop วนจาก N - 0 เเล้ว กำหนดเงื่อนไขว่าถ้า loop นั้น N หาร 10 ลงตัวให้ เก็บ จำนวนนั้น เข้า list เเล้วพอloop เสร็จให้ printlistn ที่ลบ [,]
```
...
```text
loop ทุกจนวนเเล้วเก็บไว้ใน list เเล้ว print
```
...
```text
Algorithm เหมื่อนในข้อ 2 เลยครับ loop/เก็เข้า list 
```
