...
```text
-รับ input a b and goal เป็น int
-x คือ เลือกค่าที่น้อยกว่าระหว่าง big and small
- y คือ การคำนวณว่าเหลือความยาวที่ต้องเพิ่มด้วยก้อนเล็กอีกกี่ชิ้น
- ถ้า  y>a แปลว่าต้องใช้ก้อนเล็กมากกว่าที่มี จอตอบ -1
else ถ้าพอให้ตอบ y
```
...
```text
check ว่า big ใ้หมดไหม เเล้วค่อยไปคิด small
```
...
```text
เลือกค่าที่น้อยกว่าระหว่าง big and small เเล้วเข้า if else check
```
