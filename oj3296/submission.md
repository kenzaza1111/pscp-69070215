...
```text
- รับค่า ของสีที่ 1 มา 3 ค่า และสีที่ 2 มา 3 ค่า
- แยกค่าของแต่ละสีออกมาเป็น R G B
- เอาค่าสีของสีที่ 1 กับสีที่ 2 ในตำแหน่งเดียวกันมาบวกกันแล้วหาร 2
- ทำแบบนี้ทั้งหมด 3 ค่า คือ R G B
- ถ้าผลลัพธ์เป็นทศนิยมให้ปัดลง
- จากนั้นแสดงค่า R G B ที่ได้ออกมา
```
...
```text
รับ input 2 บรรทัด
แล้วใช้ split แยกตัวเลขออกมา
จากนั้นเอา R กับ R, G กับ G และ B กับ B มาหาค่าเฉลี่ย
แล้ว print ค่าที่ได้ออกมา 3 ค่า
```
...
```text
รับ input ของสีที่ 1 และสีที่ 2 มาเก็บไว้ในตัวแปร
ใช้ split แยกค่าของแต่ละสี
จากนั้นใช้ int แปลงค่าจาก string เป็นตัวเลข
แล้วเอาค่าของแต่ละช่องมาบวกกันและหาร 2

ใช้ math.floor() เพื่อปัดค่าที่ได้ลง
แล้ว print ค่า R G B ออกมาในบรรทัดเดียว
```
...
```text
ทดสอบกรณีที่ค่าสีทั้งสองสีเท่ากัน
```
...
```text
ทดสอบกรณีที่ค่าเฉลี่ยออกมาเป็นทศนิยม และต้องปัดลง
```
