...
```text
1. มี input 2 ตัว คือ color1 and color2
2. สร้าง list name allcolor เพื่อ เก็นข้อความที่จะตั้ง input ทั้งหมด
3. สร้างเงื่อนไข 2 ชั้น เช่น color1 = Red เเละ color2 = Yellow หรือ color1 = Yellow เเละ color2 = Red จากนั้นให้ print Orange ตามที่โจทย์ให้ ทำซ้ำไป
4. เงื่อนไขสุดท้ายคือ color1 == color2 ถ้า user input text มาเหมื่อนกันเเล้วเป็น text ที่อยุ่ใน list
5. เรียกใช้ main()
```
...
```text
Step 1:รับ input color1 and color2 
Step 2:เพิ่ม if statement เเล้ว check เงื่อนไขตามโจทย์ว่า color อะไร ผสมเเล้วได้ color อะไร print() อะไร
Step 3:เรียกใช้ function main()
```
...
```text
ผมจะเพิ่มการ check text ใน color1 and 2 โดย list text สามารถ ใส่ได้ ในตัวเเปร allcolor เเล้วใส่ if-else ใหญ่ ครอบไว้โดย check ว่า color1 and color2 อยุ่ใน list allcolor หรือเปล่า ถ้าไม่อยุ่ให้ print("Error")
```
...
```text
เพราะเป็นเงื่อนไขที่ text color1 and 2 เหมื่อนกันเเล้วอยู่ใน list เหมื่อนกันด้วย
```
...
```text
เพราะ ค่าของ color1 มันไม่ได้อยู่ใน list allcolor
```
...
```text
คิดเงื่อนไขความเป็นไปได้ทั้งหมด
```
