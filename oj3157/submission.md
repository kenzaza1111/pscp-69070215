...
```text
- รับ intinput count เเละ  answer(ตัวแปรเก็บคะแนน) = 0
- เเล้ว looped ตั้งเเต่ 0 - count เเล้วการ loop เเต่ละครั้ง จะรับ ตัวค่า x(เครื่องหมาย) ด้วย 
- ในเเต่ละ loop จะ check if else
ถ้า x == "+" ให้ answer +=10
ถ้า x == "-" ให้ answer -=10
- เเล้ว print answer ออกมา
```
...
```text
รับ input มา เเล้ว looped check xว่า str เป็น + or - เเล้วคืนค่ากลับไปใน answer
```
...
```text
ถ้าวิธีสุดท้ายเหมือนกับแผนแรก  รับ input มา เเล้ว looped check
```
