...
```text
1. ผมสร้าง function main แล้วรับ input 2 ค่า คือ mounth and day
2. สร้างเงื่อนไข if else โดยกำหนดให้ ex ถ้า 1<= mounth <=3 เป็นเงื่อนไขแรก แล้วทำการ check เงื่อนไข 2 โดย ถ้า  mounth ==3  and day >= 21 จากนั้นให้เก็บค่า weather เป็น weather ถัดไปตามโจทย์
3. เรียกใช้ main()
```
...
```text
สร้าง function main แล้ว รับ input mounth and day จากนั้นเข้าเงื่อนไข if ซ้อน if โดย if แรก จะเป็นการ check mounth ว่า อยู่ mounth ไหนแล้ว ใน  if ก็มี การ  Check เงื่อนไข ถ้า เป็น mounth ท้ายสุด ของ weather นั้นแล้ววถ้าเป็น day >= 21 จากนั้นให้เปลี่ยน weather เป็น weather ต่อไป   แล้ว เรียกใช้ def main 
```
...
```text
เพราะ เป็น testcase ที่ตรงเงื่อนไข if ตัวเเรกพอดี
```
