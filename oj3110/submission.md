...
```text
-รับ input text  เเล้ว spilt เก็บเป็นตัวเเปร first sec and kg
- สร้าง dict เก็บข้อมูลใน ROUTES 
- check ว่า first,sec อยุ่ใน ROUTES ไหม ถ้าเจอ ก็ดึง value ออกมาแยกใส่ 2 ตัวแปร(one two)พร้อมกัน เเล้วคำนวนสูตร จากนั้น printออกมาในเเบบทศนิยม 2 ตำเเหน่ง ถ้า else ให้ print(Error)
...
```text
ต้องเก็บไว้ใน dict ก่อนเพระาถ้าใช้ if else จะติด pep8 เเล้วค่อย เรียกใช้ dict ในเงื่อนไข
```
